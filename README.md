...
Website undangan ini merupakan website client pertama saya mengenai tampilan undangan mulai dari nama penerima undangan, coutdown waktu pernikahan, nama mempelai, kisah cinta, galery yang diringi menggunakan lagu dengan mengunakan teknologi **HTML (Hypertext Markup Language)**, **CSS (Cascading Style Sheet)**, **Javascript**, **BOOSTRAP CSS**, **Ajax Jquery**, **OWL Carousel**, dan **AOS Animation**
